...
<Note>
  For every prompt you enter, you can go back into the chat and click <b>
  Revert This</b>

   anytime to undo your prompt.
...
1. Type a clear prompt into the chat.\
   Example: _Build a task manager where users can create, categorize, and complete tasks while tracking streaks._
