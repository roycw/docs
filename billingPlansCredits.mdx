...
**Bare in mind that credits usage is also calculated based on the size of the app, up to 4 credits.**
...
No — **all features are available on all plans**. The only difference is how many credits you get each month.
