...
<Note> Freezing files doesn’t remove them from your project — it only locks them against modification by the AI builder. </Note>
...
3. You’ll see a list of all files under **Lock Files**.
   ...
   ![Screenshot 2025-10-24 at 12.26.09.png](/images/Screenshot2025-10-24at12.26.09.png)
...
<Tip> You can quickly toggle all files at once using the **Unfreeze All** button. </Tip>
